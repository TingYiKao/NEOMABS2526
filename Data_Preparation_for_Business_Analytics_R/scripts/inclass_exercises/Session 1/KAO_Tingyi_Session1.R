...
# Exercise 1.2
# a) Construct three normal random vectors of 100 length (in other words, each vector contains 100 random numbers from a standard normal distribution). Use the rnorm() function. Name these vectors x1, x2 and x3. 
